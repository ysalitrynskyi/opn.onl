        ...
        <>
            ...
            <main>
                ...
                <section className="relative border-b border-line overflow-hidden">
                    ...
                    <picture>
                        <source srcSet="/bg-network.avif" type="image/avif" />
                        <source srcSet="/bg-network.webp" type="image/webp" />
                        <img src="/bg-network.png" alt="" aria-hidden="true" loading="lazy" decoding="async" className="pointer-events-none absolute -top-12 right-0 hidden lg:block w-2/3 max-w-3xl opacity-60 [mask-image:linear-gradient(to_left,black,transparent_80%)]" />
                    </picture>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 lg:pb-28">
                    <div className="relative rounded-4xl bg-ink text-white overflow-hidden">
                        <picture>
                            <source srcSet="/bg-network.avif" type="image/avif" />
                            <source srcSet="/bg-network.webp" type="image/webp" />
                            <img src="/bg-network.png" alt="" aria-hidden="true" loading="lazy" decoding="async" className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-20 [mask-image:radial-gradient(120%_120%_at_100%_0%,black,transparent_75%)]" />
                        </picture>
...
{'  '}-d <span className="text-emerald-600">{'\'{"original_url":"https://…"}\''}</span>
                ...
                <section className="relative overflow-hidden max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
                    <picture>
                        <source srcSet="/bg-contours.avif" type="image/avif" />
                        <source srcSet="/bg-contours.webp" type="image/webp" />
                        <img src="/bg-contours.png" alt="" aria-hidden="true" loading="lazy" decoding="async" className="pointer-events-none absolute inset-0 h-full w-full object-cover opacity-[0.35] [mask-image:radial-gradient(90%_120%_at_15%_100%,black,transparent_70%)]" />
                    </picture>
